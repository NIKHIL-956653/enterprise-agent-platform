...
Importing every model here is what puts it on Base.metadata. Alembic autogenerate compares
the database against that metadata - a model that is never imported is invisible to it, and
you get a silent empty migration instead of an error.
